const privacyPolicy = () => {
  return (
    <div className="bg-white p-4">
      <h1 className="text-2xl font-bold mb-4">Privacy Policy for Pet Feed</h1>

      <p className="mb-4">
        At Pet Feed, accessible from https://pet-feed-phi.vercel.app, one of our
        main priorities is the privacy of our visitors. This Privacy Policy
        document contains types of information that is collected and recorded by
        Pet Feed and how we use it.
      </p>
      ...
      <p className="mb-4">
        ...
        shared and/or collect in Pet Feed. This policy is not applicable to any
      ...
      <p className="mb-4">
        Pet Feed follows a standard procedure of using log files. These files
        log visitors when they visitwebsites. All hosting companies do this and
      ...
      <h2 className="text-xl font-bold mt-6 mb-4">Cookies and Web Beacons</h2>

      <p className="mb-4">
        Like any other website, Pet Feed uses &apos;cookies&apos;. These cookies
      ...
      <p className="mb-4">
        ...
        advertising partners of Pet Feed.
      </p>

      <p className="mb-4">
        Third-party ad servers or ad networks uses technologies like cookies,
        JavaScript, or Web Beacons that are used in their respective
        advertisements and links that appear on Pet Feed, which are sent
      ...
      <p className="mb-4">
        Note that Pet Feed has no access to or control over these cookies that
      ...
      <p className="mb-4">
        Pet Feed&apos;s Privacy Policy does not apply to other advertisers or
      ...
      <p className="mb-4">
        ...
        notsell the consumer&apos;s personal data.
      </p>
      <p className="mb-4">
      ...
      <p className="mb-4">
        Pet Feed does not knowingly collect any Personal Identifiable
